...
export async function submitForApproval(
  ...
  return handleHonoResponse<SubmitForApprovalResponse>(response);
}
...
export async function approvePlanning(
  ...
  return handleHonoResponse<ApprovalActionResponse>(response);
}
...
export async function reviewPlanning(
  ...
  return handleHonoResponse<ReviewPlanningResponse>(response);
}
