...
interface FacilityFilterDialogProps {
  ...
  label?: string
  districtId: number | undefined // ✅ Required districtId
...
export const FacilityFilterDialog: React.FC<FacilityFilterDialogProps> = ({
  ...
  // ✅ Fetch facilities from API dynamically based on selections
  console.log("selectedProgram:: ", selectedProgram)
  console.log("selectedProgramName:: ", selectedProgramName)
  console.log("districtId:: ", districtId)
  console.log("selectedReportingPeriodId:: ", selectedReportingPeriodId)
        ...
        {((isExecutionMode ? executionData : planningData)) && ((isExecutionMode ? executionData : planningData)!.count === 0) && selectedProgram && selectedFacilityType && (
          <div className="text-sm text-muted-foreground mt-2">
            {isExecutionMode
              ...
              : "No facilities available for planning in this district."}
          </div>
        )}
