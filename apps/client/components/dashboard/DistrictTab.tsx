...
export function DistrictTab({
  ...
  console.log("[DistrictTab] Render", {
    ...
    metricsData,
    programDistributionData: programDistributionData?.length,
    budgetByFacilityData: budgetByFacilityData?.length,
    districtApprovalsData: districtApprovalsData?.length,
    isLoadingMetrics,
    isLoadingProgramDistribution,
    isLoadingBudgetByFacility,
    isLoadingDistrictApprovals,
    accessRights: {
      canViewDistrictLevelCharts: accessRights.canViewDistrictLevelCharts,
      canViewBudgetByFacilityChart: accessRights.canViewBudgetByFacilityChart,
      canViewDistrictApprovalTable: accessRights.canViewDistrictApprovalTable,
    },
  });
