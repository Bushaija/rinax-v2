# HIV Project Planning Data & Budget Framework

## OVERVIEW

This document outlines the planned/budgeted figures for the HIV project that correspond to the actual figures tracked in `financial-data.md`. This planning framework enables comprehensive budget vs actual reporting and variance analysis.

## PLANNING METHODOLOGY

### Quarterly Planning Structure
- **Q1 (Jul-Sep)**: Planning and preparation phase
- **Q2 (Oct-Dec)**: Implementation phase I
- **Q3 (Jan-Mar)**: Implementation phase II  
- **Q4 (Apr-Jun)**: Implementation phase III and evaluation

### Budget Categories Alignment
The planning categories map directly to the expenditure categories in financial statements:

| **Planning Category** | **Financial Statement Mapping** |
|----------------------|--------------------------------|
| Human Resources (HR) | Human Resources |
| Travel Related Costs (TRC) | Monitoring & Evaluation + Client Support Services |
| Health Products & Equipment (HPE) | Overheads (Infrastructure) |
| Program Administration Costs (PA) | Overheads (Operations) |
