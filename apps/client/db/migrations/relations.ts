...
import { projects, categories, activities, activityEventMappings, events, categoryEventMappings, subCategories, provinces, districts, facilities, executionData, reportingPeriods, budgetAllocations, users, account, planActivityBudgetMappings, planningCategories, planningActivities, session, planningData, statementTemplates, financialEvents } from "./schema";
